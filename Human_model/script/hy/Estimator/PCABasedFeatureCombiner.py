...
class PCABasedFeatureCombiner(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, n_pcas=10, top_n=5, n_skip=0, scaler_name='StandardScaler', from_pca = 1, svd_solver='auto'):
    ...
    def transform(self, X):
        ...
        # X_combined.to_csv(f"PCA_{X_combined.shape[0]}_{X_combined.shape[1]}.csv")
        return X_combined
